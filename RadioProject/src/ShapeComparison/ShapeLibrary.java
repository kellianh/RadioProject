...
public class ShapeLibrary
{
    ...
    List<Shape> library = new ArrayList<>();

    public List<Shape> Library { get { return library; } }


    public ShapeLibrary(String libraryName, boolean forceCopy = false) {
    ...
    public boolean AddMultiStroke(MultiStroke multiStroke) {
    ...
    void CopyToPersistentPath(boolean forceCopy) {
